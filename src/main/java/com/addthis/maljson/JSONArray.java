...
public class JSONArray {
    ...
    private List<LineNumberInfo> arrayLineNumberInfo;
    ...
    public JSONArray() {
        ...
        arrayLineNumberInfo = new ArrayList<LineNumberInfo>();
        lineNumberInfo = LineNumberInfo.MissingInfo;
    }
    ...
    public JSONArray(JSONTokener readFrom) throws JSONException {
        ...
        if (object instanceof JSONArray) {
            ...
            arrayLineNumberInfo = ((JSONArray) object).arrayLineNumberInfo;
            lineNumberInfo = ((JSONArray) object).lineNumberInfo;
        } else {
    ...
    public JSONArray setLineNumber(int index, LineNumberInfo lineInfo) {
        while (arrayLineNumberInfo.size() <= index) {
            arrayLineNumberInfo.add(LineNumberInfo.MissingInfo);
        }
        arrayLineNumberInfo.set(index, lineInfo);
        return this;
    }

    /**
     * Get the line number of the value associated with an index.
     * @param index
     *  The index must be between 0 and length() - 1.
     * @return The LineNumberInfo value.
     */
    public LineNumberInfo getLineNumber(int index) throws JSONException {
        LineNumberInfo info = null;
        if (index >= 0 && index < this.arrayLineNumberInfo.size()) {
            info = this.arrayLineNumberInfo.get(index);
        }
        return info == null ? LineNumberInfo.MissingInfo : info;
    }

    public LineNumberInfo getMyLineNumberInfo()
    {
